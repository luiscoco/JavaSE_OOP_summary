...
**2. Encapsulation**- Binding (or wrapping) code and data together into a single unit are known as encapsulation
...
**4. Polymorphism**- If one task is performed in different ways, it is known as polymorphism. In Java, we use method overloading and method overriding to achieve polymorphism
